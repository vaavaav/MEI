...
EmptiesIfFilled == ~(\A m \in channel : m > -1) ~> ~(\A m \in channel : m = -1)

\* Negamos este invariante, para assim obter o contra exemplo. 
...
\* (e) utilizamos o invariante em (c), desta vez sem o negar.

=============================================================================
\* Modification History
\* Last modified Fri May 20 12:00:59 WEST 2022 by vaavaav
