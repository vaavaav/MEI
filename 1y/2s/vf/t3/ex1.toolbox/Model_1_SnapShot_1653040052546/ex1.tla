...
\* Para obter um exemplo onde todos entram na região crítica, basta criar um invariante que nega essa afirmação para assim
\*    a ferramente mostrar um contra exemplo

AllGoCritical == (\A p \in 1..N : (<>(isCritical[p])) /\ [] (isCritical[p] ~> isCritical[p])) 

\* agora mete-se ~AllGoCritical como propriedade

=============================================================================
\* Modification History
\* Last modified Fri May 20 10:46:32 WEST 2022 by vaavaav
