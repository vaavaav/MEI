...
EventuallyCritical == \A p \in 1..N : (~isCritical[p] ~> isCritical[p]) 
...
\* Qualque processo que não esteja na região crítica, inevitavelmente chega lá.

AlwaysEventuallyCritical == \A p \in 1..N : [](~isCritical[p] ~> isCritical[p]) 

\* agora mete-se ~AlwaysEventuallyCritical como propriedade

-----------------------------------------------------------------------------

\* (f) trata-se de uma questão de strong fairness.
...
\* (g) É de liveness, uma vez que não diz o que o algoritmo _pode_ fazer (safety), mas sim sobre o que _deve_ fazer (liveness).
\* I.e., o mesmo processo não DEVE entrar duas vezes seguidas na região critica se outros estiverem à espera.


=============================================================================
\* Modification History
\* Last modified Fri May 20 11:02:57 WEST 2022 by vaavaav
